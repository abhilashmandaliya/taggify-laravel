...
<head>
    ...
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/taggify.css') }}">
        ...
        <script src="{{ asset('js/taggify.js') }}"></script>
        </head>
        <body>
        <nav class="navbar navbar-default">
                ...
                @auth
                        <a class="navbar-brand" href="/home">#Taggify</a>
                @else                
                        <a class="navbar-brand" href="/">#Taggify</a>
                @endauth
                </div>
